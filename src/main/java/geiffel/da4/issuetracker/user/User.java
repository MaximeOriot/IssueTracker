...
import geiffel.da4.issuetracker.commentaire.CommentaireJSONSerialize;
...
public class User {
    ...
    @JsonSerialize(contentUsing = CommentaireJSONSerialize.class)
    private List<Commentaire> commentaireEcrits;
    @OneToMany(mappedBy = "emitter")
    @JsonSerialize(contentUsing= IssueJSONSerializer.class)
